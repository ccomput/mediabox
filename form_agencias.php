...
$delete	= @$_GET["delete"];
$table	= "mp_agency";
$page	= "Location:agencias.php?viewer=agencias";
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							<?php if($id <> "new"){echo 'Editar';}else{ echo 'Adicionar'; } ?> Agência
						</h3>
						<ul class="breadcrumb">
							<li>
								<a href="/">Painel</a>
					...
					<div class="span12">
						...
						<div class="widget green">
							<div class="widget-title">
								<h4><i class="icon-reorder"></i> Dados da Agência</h4>
								<div class="tools">
							...
							<div class="widget-body form">
								<div class="bs-docs-example">
									...
									<form class="cmxform form-horizontal" id="clientesForm" method="post" action="#" enctype="multipart/form-data">
										...
										<div class="tab-content" id="myTabContent">
											...
											<div id="contato" class="tab-pane fade">
												...
												<div class="control-group ">
													...
													<div class="controls controls-row">
														<input class="span6" id="fone1" name="fone1" type="text" value="<?php echo @$fone1; ?>" data-mask="99 9999-9999" required />
													</div>
												</div>
