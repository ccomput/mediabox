					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li class="pull-right search-wrap">
								<a href="form_usuarios.php?id=new"><button class="btn btn-warning" style="height:36px; margin-top:-8px;"><i class="icon-plus icon-white"></i> Adicionar</button></a>
							</li>
						</ul>
						...
						<div class="widget orange">
							...
							<div class="widget-body">
								<table class="table table-striped table-bordered" id="sample_1">
									...
									<tbody>
									<?php
									$busca = "SELECT ukey, nome, apelido, mail FROM mp_user ORDER BY nome";
