...
/*if (preg_match('/Firefox/i', $user_agent) and preg_match('/Windows NT 5.1/i', $user_agent)){
	echo '';
}elseif(preg_match('/Firefox/i', $user_agent) and preg_match('/Windows NT 6.1/i', $user_agent)){
	echo '';
}elseif(preg_match('/Firefox/i', $user_agent) and preg_match('/Windows NT 6.2/i', $user_agent)){
	echo '';
